    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="w-1/2 flex items-center justify-center bg-gray-50 h-full">
          <div className="max-w-lg px-8">
            <h1 className="text-5xl font-extralight text-gray-900 mb-8 tracking-wider leading-tight">
              ...
              CLOTHES.
              <br />
              <span className="font-light">A CAUSE. A CRAFT.</span>
              <br />
              <span className="font-light">A COMMUNITY.</span>
            </h1>
            <Link
              to="/collections"
              className="inline-block bg-black text-white px-6 py-3 text-sm font-light hover:bg-gray-800 transition-colors uppercase tracking-widest"
            >
              Learn More
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 font-light leading-relaxed">
                Each piece is made mindfully with local artisans
              </p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h3 className="text-3xl font-light mb-6 tracking-wide">Join Our Community</h3>
          <p className="text-lg text-gray-600 font-light mb-8 leading-relaxed">
            Be part of a movement that celebrates authentic self-expression, sustainability, and inclusive fashion.
          </p>
          <Link
            to="/collections"
